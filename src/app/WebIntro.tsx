    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <p>Press <span className="bg-gray-800 px-2 py-1 rounded">Enter</span> to continue</p>
            <p>Press <span className="bg-gray-800 px-2 py-1 rounded">Esc</span> to cancel</p>
            <motion.h1
